    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGrant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                                ...
                                public void onPermissionDenied(PermissionDeniedResponse response) {
                                    if (response.isPermanentlyDenied()) {
                                        ...
                                        builder.setTitle("Permission Denied")
                                                .setMessage("Cihaz konumuna erişim izni kalıcı olarak reddedildi. izne izin vermek için ayara gitmeniz gerekir.\n")
                ...
                {
                    Toast.makeText(PermissionsActivity.this, "İNTERNET BAĞLANTINIZI KONTROL EDİN", Toast.LENGTH_SHORT).show();
                }
        }
